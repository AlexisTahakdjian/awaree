  ...
  return (
    <>
      <Box className={classes.texte}>
        ...
        <Typography paragraph variant="h6">
          <strong>Commencons par choisir trois compétences , vous pourrez les modifier ou en ajouter d’autres à tout
            moment sur votre profil.</strong>
        </Typography>
        <Typography className={classes.desc} variant="h6">Ajouter des compétences comportementales :</Typography>
